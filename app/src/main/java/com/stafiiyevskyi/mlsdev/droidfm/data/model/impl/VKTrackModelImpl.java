...
public class VKTrackModelImpl implements VKTrackModel {
    ...
    public Observable<VkPopularTrackResponse> getVkPopularTracks(int genreId, int offset, int count) {
        String fullUrl = "https://api.vk.com/method/audio.getPopular?only_eng=1&genre_id=" + genreId + "&count=" + count + "&offset=" + offset + "&access_token=" + PreferencesManager.getInstance().getAccessToken() + "&v=5.52";
